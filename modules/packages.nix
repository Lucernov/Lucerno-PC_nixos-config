...
let
  ...
  systemPackages = with pkgs; [
    ...
    qt5.qtbase                                                  # базовые библиотеки Qt5 и плагин XCB
    qt5.qtwayland                                               # плагин Wayland для Qt5
    qt6.qtbase                                                  # базовые библиотеки Qt6 и плагин XCB
    qt6.qtwayland                                               # плагин Wayland для Qt6

...

{
  ...
  # ========== мои симлинки ==========
  systemd = {
    tmpfiles.rules = links.systemRules;                                                         # Правила из links.nix (создание каталогов, прав доступа и ссылок для rclone, ComfyUI и т.д.)
  };
  ...
  time = {
    timeZone = "Europe/Moscow";                                                                 # Часовой пояс (Europe/Moscow)
  };

...

{
  ...
  systemd.tmpfiles.rules = [                                                                            # Правила tmpfiles
    ...
    "L+ ${myLib.home}/.lv2/drumkv1.lv2 - ${myLib.userName} ${myLib.userName} - /run/current-system/sw/lib/lv2/drumkv1.lv2"
    ...
    "L+ \"${myLib.home}/.lv2/ZL Splitter.lv2\" - ${myLib.userName} ${myLib.userName} - /run/current-system/sw/lib/lv2/ZL Splitter.lv2"
    ...
    "L+ \"${myLib.home}/.vst3/PitchNet.vst3\" - ${myLib.userName} ${myLib.userName} - /run/current-system/sw/lib/vst3/PitchNet.vst3"
    "L+ \"${myLib.home}/.vst3/RipplerX.vst3\" - ${myLib.userName} ${myLib.userName} - /run/current-system/sw/lib/vst3/RipplerX.vst3"
    ...
    "L+ \"${myLib.home}/.vst3/ZL Spectrum Equalizer.vst3\" - ${myLib.userName} ${myLib.userName} - /run/current-system/sw/lib/vst3/ZL Spectrum Equalizer.vst3"
    "L+ \"${myLib.home}/.vst3/ZL Splitter.vst3\" - ${myLib.userName} ${myLib.userName} - /run/current-system/sw/lib/vst3/ZL Splitter.vst3"
    # Air-G Plugins

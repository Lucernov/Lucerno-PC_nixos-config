...

{
  ...
  systemd.tmpfiles.rules = [                                                                            # Правила tmpfiles
    ...
    #"L+ /usr/bin/kdialog - - - - /run/current-system/sw/bin/kdialog"
    ...
    "L+ ${myLib.home}/.clap/sforzando.clap - lucerno lucerno - /run/current-system/sw/lib/clap/sforzando.clap"
    ...
    "L+ \"${myLib.home}/.vst3/sforzando.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/sforzando.vst3"
    ...
    # Air-G Plugins
    "L+ \"${myLib.home}/.vst3/AirGClip.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGClip.vst3"
    "L+ \"${myLib.home}/.vst3/AirGDess.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGDess.vst3"
    "L+ \"${myLib.home}/.vst3/AirGEaseq.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGEaseq.vst3"
    "L+ \"${myLib.home}/.vst3/AirGEchoes.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGEchoes.vst3"
    "L+ \"${myLib.home}/.vst3/AirGMods.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGMods.vst3"
    "L+ \"${myLib.home}/.vst3/AirGPop.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGPop.vst3"
    "L+ \"${myLib.home}/.vst3/AirGPopMini.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGPopMini.vst3"
    "L+ \"${myLib.home}/.vst3/AirGPrism.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGPrism.vst3"
    "L+ \"${myLib.home}/.vst3/AirGPulse.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGPulse.vst3"
    "L+ \"${myLib.home}/.vst3/AirGPulseMini.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGPulseMini.vst3"
    "L+ \"${myLib.home}/.vst3/AirGSpaces.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGSpaces.vst3"
    "L+ \"${myLib.home}/.vst3/AirGTape.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGTape.vst3"
    "L+ \"${myLib.home}/.vst3/AirGTaped.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGTaped.vst3"
    "L+ \"${myLib.home}/.vst3/AirGTapedMini.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGTapedMini.vst3"
    "L+ \"${myLib.home}/.vst3/AirGVelvet.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGVelvet.vst3"
    "L+ \"${myLib.home}/.vst3/AirGVelvetMini.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGVelvetMini.vst3"
    "L+ \"${myLib.home}/.vst3/AirGVolt.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGVolt.vst3"
    "L+ \"${myLib.home}/.vst3/AirGVoltMini.vst3\" - lucerno lucerno - /run/current-system/sw/lib/vst3/AirGVoltMini.vst3"
